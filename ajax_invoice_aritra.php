...
elseif ($action_type == "SELECT_INVOICE") {
  ...
  ('" . $booking_id . "', ";
    ...
    if ($invoice_type == 'Booking Invoice') {
        $check_qry = "SELECT COUNT(1) AS cnt FROM received_detail WHERE invoice_id = '" . $invoice_id . "' AND invoice_type = 'B'";
        ...
        $check_qry = "SELECT COUNT(1) AS cnt FROM received_detail WHERE invoice_id = '" . $invoice_id . "' AND invoice_type = 'M'";
        ...
        $check_qry = "SELECT COUNT(1) AS cnt FROM received_detail WHERE invoice_id = '" . $invoice_id . "' AND invoice_type = 'P'";
